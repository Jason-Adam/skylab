"""
One-time data preparation for skylab experiments.
...
Data and tokenizer are stored in ~/.cache/skylab/.
"""
...
CACHE_DIR = os.path.join(os.path.expanduser("~"), ".cache", "skylab")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Prepare data and tokenizer for skylab"
    )
    parser.add_argument(
        "--num-shards",
        type=int,
